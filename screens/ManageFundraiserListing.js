  ...
  return (
    <ScrollView style={styles.sview}>
      ...
      <View style={styles.viewStyle}>
        ...
        <Text style={styles.creatorInitialText}>Status: <Text style={styles.creatorText}>Active </Text> </Text>
        ...
        {currentState === "Fundraising" ? (
          ...
          <Text style={styles.fundraisingEnded}>This project has ended. The funds have been sent to your wallet.</Text>
        )}
