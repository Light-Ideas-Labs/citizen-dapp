    ...
    <View style={styles.container}>
      {loggedIn ? ( 
          ...
          {count === 0  ? (
            <View style={styles.itemsContainer}>
              <View style={styles.headerInitial}>
                <View>
                  <Text style={styles.titleHeader}>My <Text style={styles.header}> projects </Text> </Text>
                </View>
              ...
              <View style={styles.centerLoginTop}>
                <Image style={styles.Image} source={require("../assets/active-project.png")}></Image>
                <Text style={styles.notifHeader}>No active projects!</Text>
                
                <Button title={"New Projects"} 
            ...
            <View style={styles.itemsContainer}>
              {/* User does have projects they made */}
              <ScrollView
                refreshControl={
                  <RefreshControl
        ...
        <View style={styles.centerLogin}>
          <Image style={styles.Image} source={require("../assets/deadline-rafiki.png")}></Image>
          <LogIn reason={"please login to view your projects!"} handleLogIn={context.handleLogIn}/>
        </View>
      )}
    </View>
  );
